...
import com.example.lazic2.service.StudentJpaService;
...
public class StudentRestController {
    ...
    @Autowired
    public StudentRestController(StudentService studentService, StudentJpaService studentJpaService) {
        this.studentService = studentService;
        this.studentJpaService=studentJpaService;
    }

    @GetMapping("/top2")
    public List<StudentDTO> getTop2(){
        return studentJpaService.getTop2StudentByECTS();
    }
